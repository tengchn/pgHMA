...
P1<-Skyline_plot(times_hma, Re_hdi_hma, xlab="Mutational units", ylab="Population size", main="HMA epsilon=0.0") #call the function Skyline_plot from pgHMAtools
...
P2<-Skyline_plot(times_hma_slide, Re_hdi_hma_slide, xlab="Mutational units", ylab="Population size", main="HMA sliding window 100 by 20") #call the function Skyline_plot from pgHMAtools
...
stopCluster(cl)
#Plot the skyline plot with nucleotide data
...
P3<-Skyline_plot(times_beast, Re_hpd_beast, xlab="Mutational units", ylab="Population size", main="Bayesian epsilon=0.0") #call the function Skyline_plot from pgHMAtools
...
P4<-Skyline_plot(times_beast_slide, Re_hpd_beast_slide, xlab="Mutational units", ylab="Population size", main="Bayesian sliding window 100 by 20") #call the function Skyline_plot from pgHMAtools
#Plot the above four plots in one figure
library(gridExtra)
