...
#define VERSION "1.4"
#define CONTACT1 "Teng Li <Teng.Li@anu.edu.au>"
#define CONTACT2 "Thomas Wong <Thomas.Wong@anu.edu.au>"
...
bool identifyPeak(string header, vector<double>& timeData, vector<double>& data, vector<int>& peakPos, double avgValue, double stdDev, double t, double m, double n, bool proceedEvenError) {
	...
	if (validResult) {
		...
		cout << "The value of d_H = " << result << endl;
	}
...
void showHelpMenu(char* argv0) {
		...
		cout << "----------------------------------------" << endl;
		cout << "Contact:" << endl;
		cout << "1. " << CONTACT1 << endl;
		cout << "2. " << CONTACT2 << endl;
		cout << "----------------------------------------" << endl;
